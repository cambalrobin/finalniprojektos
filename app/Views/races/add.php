...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <?php
            // Nastavení vzhledu (Bootstrap třída), unikátního ID pro JavaScript a nápovědy (placeholderu) pro textové pole názvu
            $atributyRaceName = [
                'class'       => 'form-control',
                'id'          => 'real_name',
            ...
            // Omezení kalendáře startu závodu – uživatel může vybrat datum pouze v rozmezí daného ročníku (od minDate do maxDate)
            $atributyZacatek = [
                'class' => 'form-control',
                'id'    => 'start_date',
                'min'   => $minDate,
            ...
            // Omezení kalendáře konce závodu – hlídá, aby konec závodu nepřesáhl hranice daného roku
            $atributyKonec = [
                'class' => 'form-control',
                'id'    => 'end_date',
                'min'   => $minDate,
